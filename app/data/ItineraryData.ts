...
export const itinerary: DayItinerary[] = [
    ...
    locations: [
  {
      ...
      },
      {
        ...
        image: "https://www.getmetotaiwan.com/wp-content/uploads/2023/09/kaohsiung-kaohsiung-music-center.webp",
  ...
  },
  {
    ...
    locations: [
      ...
      },
      {
        ...
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8IfZ2o2vrbWqu5Zipo8DwY7xXaDZzDO3N4w&s",
        mapLink: "https://maps.app.goo.gl/sQ2c8GXZdFoLaKjM6",
      },
      {
  ...
  },
  {
    ...
    locations: [
      ...
      {
        name: "2. HSR về Đài Bắc",
        time: "Chiều tối",
        description: "- HSR cao tốc tới Đài Nam 47 phút, về khách sạn nghỉ ngơi\n",
        image: "https://i.etsystatic.com/16237790/r/il/591da5/5840470695/il_fullxfull.5840470695_gwx4.jpg",
        mapLink: "https://maps.app.goo.gl/u8FgLGoc6JWG28jb6",
      },
      {
      ...
      {
        name: "4. Diao Min Asia Sauerkraut Fish",
        time: "Tối",
      ...
      {
        name: "5. Cơm gà Shan Nei chợ đêm Nanjichang",
        time: "Tối",
  ...
  },
  {
      ...
      },
    {
        ...
        time: "Sáng trưa",
        description: "- Có thể bỏ qua đi sau\n - Có thể đi thăm Lăng, phủ tổng thống, đi cáp treo,...",

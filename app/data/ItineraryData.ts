...
export const itinerary: DayItinerary[] = [
  ...
  //     },
  {
      ...
      },
      {
        ...
        image: "https://lh3.googleusercontent.com/gps-cs-s/AC9h4nq4AdtJHon58K8Yl81rlCHxgD6x4zWntd3zM8jHCW4mQwvnpVkSyhnjCeuEZSHESeOHl-PK1Xt4RXAoygmuhWZPzw5JFgIuaiWgUO7cDN4UuuQlAvBVXNrHyPfZYiIiWYvtmnUOyEidwIxf=w408-h544-k-no",
      ...
      {
        name: "10. Ngỗng hun khói A Cheng",
        time: "Tối",
  ...
  },
  {
    ...
    locations: [
      ...
      },
      {
        ...
        time: "Tối",
        description: "- Ở Ximen luôn, canh cá cay ngon nổi tiếng",
  ...
  },
  {
    ...
    locations: [
      ...
      // },
      {
        name: "1. Ăn trưa",
        time: "Trưa",
        description: "- Đi HSR cao tốc từ Đài Trung tới Đài Nam 37 phút, có thể về khách sạn nghỉ rồi đi\n",
        image: "https://i.etsystatic.com/16237790/r/il/591da5/5840470695/il_fullxfull.5840470695_gwx4.jpg",

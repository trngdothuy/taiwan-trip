...
export const itinerary: DayItinerary[] = [
  ...
  },
  {
    ...
    locations: [
      ...
      // },
      {
        name: "1. Fu Sheng Hao",
        time: "Sáng",
        description: "- Có thể ăn sáng ở Đài Trung trước rồi đi HSR cao tốc tới Đài Nam 37 phút\n - Có thể về khách sạn gửi đồ rồi đi ăn\n - Ăn sáng Đài Trung 60 năm\n- Mở cửa 6h30 - 18h30\n - Wangou (bánh bột gạo mặn) + súp thịt heo",
      ...
      },
      {
        ...
        time: "Trưa",
        description: "- Taxi 9p từ chùa\n - Mở cửa từ 10h30 - 21h30\n - Cuộn tôm chiên giòn, cơm hải sản, canh súp",
  ...
  },
  {
    ...
    locations: [
      ...
      {
        name: "6. Vịnh Sông Tình Yêu (Love River)",
        time: "Tối",
